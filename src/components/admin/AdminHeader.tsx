...
export default function AdminHeader() {
  ...
  return (
    <header className="h-16 bg-white border-b border-gray-200/80 flex items-center justify-between px-6 lg:px-8 sticky top-0 z-30">
      <div>
        <h2 className="text-sm font-bold text-gray-900">{page.title}</h2>
        {page.desc && <p className="text-[11px] text-gray-400">{page.desc}</p>}
      </div>
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="flex items-center gap-1.5 text-xs text-gray-400 hover:text-gray-800 transition-colors px-3 py-1.5 rounded-lg hover:bg-gray-100 font-medium"
        >
